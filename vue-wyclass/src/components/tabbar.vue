<template>
  <div class="tab">
    <mt-tabbar  v-show="isShowTabbar" fixed>
      <mt-tab-item id="home" class="tabbar-item" @click.native="changeToMain">
        <i slot="icon" class="icon iconfont icon-shouye" :style="maincolor"></i>
        首页
      </mt-tab-item>
      <mt-tab-item id="classify" class="tabbar-item" @click.native="changeToClass">
        <i slot="icon" class="icon iconfont icon-leimupinleifenleileibie2" :style="classifycolor"></i>
        分类
      </mt-tab-item>
      <mt-tab-item id="mystudy" class="tabbar-item" @click.native="changeToLearn">
        <i slot="icon" class="icon iconfont icon-icon" :style="learncolor"></i>
        经典
      </mt-tab-item>
      <mt-tab-item id="account" class="tabbar-item" @click.native="changeToMy">
